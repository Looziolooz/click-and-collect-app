...
export default function AdminDashboard() {
  ...
  // FIX IDRATAZIONE: Inizializziamo a null invece che new Date()
  // Questo evita che il server renderizzi un orario diverso dal client
  ...
  const fetchOrders = useCallback(async () => {
    ...
    try {
      ...
      // Aggiorniamo la data solo ORA (sul client, dopo il caricamento)
  ...
  const formatPickupTime = (dateStr: string) => {
    // Anche qui, per evitare errori di idratazione se il componente viene renderizzato lato server,
    // bisognerebbe assicurarsi che la formattazione sia consistente.
    // Tuttavia, poiché questi dati arrivano dalla fetch (che avviene in useEffect), non dovrebbero causare problemi.
        ...
        <div className="flex items-center gap-4">
          <div className="text-right hidden sm:block">
            ...
            <p className="font-mono text-sm font-bold text-gray-600">
              {/* FIX IDRATAZIONE: Renderizziamo solo se lastUpdated esiste (è stato caricato sul client) */}
